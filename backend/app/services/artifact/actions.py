...
from app.models import Artifact, Confirmation, Memory, Run, SkillCandidate, Tool, UIInteractionEvent
from app.schemas import ArtifactActionResult
from app.schemas.artifact import ArtifactAction, ArtifactBlock, ArtifactSpecV1, StateBinding, SUPPORTED_ACTION_TYPES
...
class ArtifactActionRuntime:
    ...
    def _resolve(self, artifact: Artifact, action_id: str, block_id: str | None) -> ResolvedAction:
        ...
        if block_id:
            ...
            if not block:
                raise ArtifactActionRuntimeError(f"Artifact block '{block_id}' was not found", status_code=404)
